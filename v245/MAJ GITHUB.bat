@echo off
title PUSH ALTHERYA -> GITHUB
echo ==========================================
echo       ENVOI ALTHERYA SUR GITHUB
echo ==========================================
echo.

REM Place ce fichier directement dans le dossier racine du bot Altherya.
cd /d "%~dp0"
...
if %errorlevel%==0 (
    ...
    git commit -m "Mise a jour Altherya"
    if errorlevel 1 goto :error
)
...
echo.
echo ==========================================
echo      ALTHERYA ENVOYE AVEC SUCCES
echo ==========================================
pause
exit /b 0
